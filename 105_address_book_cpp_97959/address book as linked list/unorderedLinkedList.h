...
//Function divides list into 2 lists of equal length
	
};
template <class Type>
void unorderedLinkedList<Type>::divideMid(linkedListType<Type>& sublist)
{
    sublist.destroyList();
    if (count > 1)
    {
